...
def matrix_html(company_name: str, profit: float, balance: float) -> str:
    ...
    return f"""
    <div style="max-width:900px;margin:0 auto 12px auto">
      <svg viewBox="0 0 800 500" role="img" aria-label="Profitability and balance-sheet matrix positioning {name}" style="width:100%;height:auto;font-family:system-ui,sans-serif">
