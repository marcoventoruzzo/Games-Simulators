...
def matrix_html(company_name: str, profit: float, balance: float) -> str:
    ...
    return f"""
    <div style="max-width:900px;height:clamp(300px,62.5vw,500px);margin:0 auto 12px auto">
      <svg viewBox="0 0 800 500" role="img" aria-label="Profitability and balance-sheet matrix positioning {name}" style="display:block;width:100%;height:100%;font-family:system-ui,sans-serif">
...
with tab_eval:
    ...
    st.html(matrix_html(company,profit_index,balance_index))
