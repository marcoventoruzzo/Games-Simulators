...
<div id="body-explorer">
  <style>
    ...
    .atlas-image{position:absolute;inset:0;width:100%;height:700px;object-fit:contain;z-index:1;transition:opacity .32s ease,filter .32s ease;filter:saturate(1.03) contrast(1.02)}
